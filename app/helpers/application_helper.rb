module ApplicationHelper
  ...
  def copyright_generator
     DevcampViewTool::Renderer.copyright 'Krishnan Pontes', 'All rights reserved'
  end
  ...
  def nav_helper_old style, tag_type
nav_links = <<NAV
...
NAV
  ...
  def alert_generator msg
    js add_gritter(msg, title: "Krishnan Pontes Portfolio", sticky: false)
  end
